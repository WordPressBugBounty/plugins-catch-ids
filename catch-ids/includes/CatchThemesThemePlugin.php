...
class CatchThemesThemePlugin
{
	...
	public function customize_register($wp_customize)
	{
		$wp_customize->add_section(
			new WP_Customize_Themes_Section(
				...
				'catchthemes',
				array(
					'title'      => __('Themes by CatchThemes', 'catch-ids'),
					'action'     => 'catchthemes',
	...
	{
		// Add our filter here
		$tabs['catchplugins'] = _x('Catch Plugins', 'Plugin Installer', 'catch-ids');
	...
	public function plugins_table()
	{
		...
		printf(
			...
			sprintf(
				...
				wp_kses_post(__('You can use any of our free plugins or premium plugins from <a href="%s" target="_blank">Catch Plugins</a>.', 'catch-ids')),
